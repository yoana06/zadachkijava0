...
public class besenica2 extends JFrame {
	...
	public besenica2() {
		...
		textField.setBounds(90, 200, 183, 41);
		panel.add(textField);
		...
		lblNewLabel.setBounds(0, 42, 658, 68);
		panel.add(lblNewLabel);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(0, 212, 325, 272);
		panel.add(panel_1);
		...
		panel_1.setVisible(false);
		 ...
		 man = new JLabel("");
		man.setIcon(new ImageIcon("C:\\Users\\Lenovo\\OneDrive - Министерство на образованието и науката\\Desktop\\besilo1.png"));
		man.setBounds(335, 0, 313, 356);
		panel.add(man);
		...
		btnguess.setBounds(90, 352, 180, 41);
		panel.add(btnguess);
		...
		start.setBounds(257, 250, 140, 49);
		panel.add(start);
	}
	...
	private void setWord() {
	    ...
	    private void besilo() {
	        ...
	        String imagePath = "C:\\Users\\Lenovo\\OneDrive - Министерство на образованието и науката\\Desktop\\besilo" + imageIndex + ".png";
