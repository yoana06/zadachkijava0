...
public class besenica2 extends JFrame {
	...
	public besenica2() {
		...
		panel_1.setVisible(false);
		 ...
		 man = new JLabel("");
		man.setIcon(new ImageIcon("pics/besilo1.png"));
	...
	private void setWord() {
	    ...
	    private void besilo() {
	        ...
	        String imagePath = "pics/besilo" + imageIndex + ".png";
	        URL imageUrl = ClassLoader.getSystemResource(imagePath);
	        if (imageUrl != null) {
	            ImageIcon hangmanIcon = new ImageIcon(imageUrl);
	            man.setIcon(hangmanIcon);
	        }
